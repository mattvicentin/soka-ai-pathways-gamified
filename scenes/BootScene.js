...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Load white male character sprites
    this.load.image('sprite-white-male-neutral', 'assets/sprites/white_male_neutral.png');
    this.load.image('sprite-white-male-concerned', 'assets/sprites/white_male_concerned.png');
    this.load.image('sprite-white-male-thoughtful', 'assets/sprites/white_male_thoughtful.png');
